...
(function ($) {
	...
	$.widget("ui.djselectable", $.ui.autocomplete, {
        ...
        select: function (item, event) {
            ...
            */
		    ...
		    try {
			if(after_selectable_do) {
			    after_selectable_do(item, $input);
			}
		    }catch(e) {console.log('ERROR SELECTABLE: '+e );}
                }
            }
        },
    ...
    function djangoAdminPatches() {
		...
		//console.log(multiWidget);
		
                if (singleWidget!=null || multiWidget!=null) {
		    ...
		    //console.log('ACA porque: '+singleWidget+' y '+multiWidget);
